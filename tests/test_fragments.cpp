...
TEST(FragmentsIdenticalSources) {
    ...
    auto a = echotrace::parse_source("void test() { int x = 0; x++; return x; }", 5, 4, opts);
    auto b = echotrace::parse_source("void test() { int x = 0; x++; return x; }", 5, 4, opts);
...
TEST(FragmentsDifferentSources) {
    echotrace::normalization::NormalizationOptions opts{};
    auto a = echotrace::parse_source("void foo() { int x = 1; }", 5, 4, opts);
    auto b = echotrace::parse_source("#include <iostream>\nint main() { std::cout << 42; return 0; }", 5, 4, opts);
    auto frags = echotrace::fragments::matched_fragments(a, b, 5);
...
TEST(FragmentsMaxLimits) {
    echotrace::normalization::NormalizationOptions opts{};
    auto a = echotrace::parse_source("int a=1; int b=2; int c=3; int d=4; int e=5;", 5, 4, opts);
    auto b = echotrace::parse_source("int a=1; int b=2; int c=3; int d=4; int e=5;", 5, 4, opts);
...
TEST(FragmentOffsetsValid) {
    echotrace::normalization::NormalizationOptions opts{};
    auto a = echotrace::parse_source("int val = 10; return val;", 5, 4, opts);
    auto b = echotrace::parse_source("int val = 10; return val;", 5, 4, opts);
    auto frags = echotrace::fragments::matched_fragments(a, b, 5);
...
TEST(FragmentTextMatchesSource) {
    ...
    auto a = echotrace::parse_source(src, 5, 4, opts);
    auto b = echotrace::parse_source(src, 5, 4, opts);
    auto frags = echotrace::fragments::matched_fragments(a, b, 5);
    for (const auto& f : frags) {
...
TEST(FragmentsK0ReturnsEmpty) {
    echotrace::normalization::NormalizationOptions opts{};
    auto a = echotrace::parse_source("auto x = 5;", 5, 4, opts);
    auto b = echotrace::parse_source("auto x = 5;", 5, 4, opts);
